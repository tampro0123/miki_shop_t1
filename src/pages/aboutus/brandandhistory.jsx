  ...
  return (
    <Page title={'Brand And History'}>
      <div className="app z-10">
        <div className="container mt-0 relative z-50">
          <BreadCrumb
            params={[
              {
                href: '/',
        ...
        <div className="relative">
          <Image src={banner} layout="responsive" placeholder="blur" />
        ...
        <div className="container">
          <div className="grid grid-cols-2 gap-11 mb-[120px]">
            <div>
              <h3 className="text-32 leading-10 font-bold mb-[32px]">Phong cách Hàn Quốc</h3>
              <p className="">
            ...
            <div className="drop-shadow-[0_0_86px_rgba(0,0,0,0.1)]">
              <Image src={Img1} className="rounded-8 overflow-hidden" layout="responsive" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-11 mb-[120px]">
            <div className="drop-shadow-[0_0_86px_rgba(0,0,0,0.1)]">
              <Image src={Img2} className="rounded-8 overflow-hidden" layout="responsive" />
            </div>
            <div>
              <h3 className="text-32 leading-10 font-bold mb-[32px]">Những câu chuyện hạnh phúc</h3>
              <p className="">
          ...
          <div className="grid grid-cols-2 gap-11">
            <div>
              <h3 className="text-32 leading-10 font-bold mb-[32px]">Sản xuất & chế tác</h3>
              <p className="">
            ...
            <div className="drop-shadow-[0_0_86px_rgba(0,0,0,0.1)]">
              <Image src={Img3} className="rounded-8 overflow-hidden" layout="responsive" />
            </div>
          </div>
        </div>
      </div>
