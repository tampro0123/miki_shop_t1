...
import { ForgotPasswordFormSection } from 'src/sections/auth';
          ...
          <div className="flex justify-center">
            <div className="flex w-[1136px] mobile:w-[375px] mobile:justify-center">
              ...
              <div className="w-[490px] bg-bgr-auth mobile:bg-transparent rounded-r-16">
                ...
                {/* Form name */}
                <h3 className="text-xl leading-7 font-bold ml-10 mt-[72px] mobile:ml-[16px] mobile:text-base mobile:leading-4 mobile:mt-[26px]">Quên Mật Khẩu ?</h3>
                {/* forgot form */}
