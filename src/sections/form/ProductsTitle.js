    ...
    return (
        <div>
            ...
            <div className="flex justify-between mt-[35px] mobile:mt-[20px]">
                ...
                <h1 className="text-xl leading-7 mobile:text-base mobile:leading-6 font-bold">{totalPriceOfProducts}</h1>
            </div>
            <div className="flex justify-between mt-[20px] mobile:mt-[12px]">
                ...
                {/* Delivery Fee */}
                <h1 className="text-xl leading-7 mobile:text-base mobile:leading-6 font-bold">{ortherFees.transportFee}</h1>
            </div>
            <div className="flex justify-between mt-[20px] mobile:mt-[12px]">
                <h1 className="text-base font-medium leading-6 text-black">Giảm giá</h1>
                {/* Disccount */}
                <h1 className="text-xl leading-7 mobile:text-base mobile:leading-6 font-bold">{ortherFees.discount}</h1>
            </div>
            ...
            <div className="flex justify-between mt-[32px] mobile:mt-[9px]">
                ...
                {/* Last Price */}
                <h1 className="text-xl leading-7 mobile:text-base mobile:leading-6 font-bold">{lastPrice}</h1>
            </div>
        </div>
    )
}
